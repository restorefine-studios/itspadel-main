		...
		<section className="py-12 md:py-20 px-8 md:px-16 lg:px-32">
			<div className="max-w-7xl mx-auto">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					<div className="rounded-3xl overflow-hidden h-[500px] relative w-full">
						<Image
						...
						<div className="w-full absolute bottom-0 left-0 z-10 p-6 h-44 bg-gradient-to-t from-[#009FF3] to-transparent">
							<h3 className="font-bison text-3xl mt-8 text-white">
								Harry Ahmed
							</h3>
							<p className="font-inter text-white">harry@itspadel.co.uk</p>
						</div>
					</div>
					<div className="hidden rounded-3xl overflow-hidden h-[500px] relative w-full">
						<Image
					...
					<div className="rounded-3xl overflow-hidden h-[500px] relative w-full">
						...
						<div className="w-full absolute bottom-0 left-0 z-10 p-6 h-44 bg-gradient-to-t from-[#009FF3] to-transparent">
							...
							<p className="font-inter text-white">jim@itspadel.co.uk</p>
						</div>
					</div>
				</div>
			</div>
