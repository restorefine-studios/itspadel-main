				...
				<div className="w-full flex flex-col-reverse md:grid grid-cols-1 lg:grid-cols-2 gap-12 items-start md:items-center">
					<div>
						...
						<p className="font-inter text-sm md:text-base text-black/50 mb-8">
							Padel is a fast-paced and addictive racket sport that combines
							elements of tennis and squash. With a smaller court and walls,
							it’s extremely easy to pick up! With two clubs built already in
							the North West and more on the way, Its Padel will make sure you
							have bringing the world’s fastest growing sport to your doorstep!
						</p>
						<Link
							href="/what-is-padel"
